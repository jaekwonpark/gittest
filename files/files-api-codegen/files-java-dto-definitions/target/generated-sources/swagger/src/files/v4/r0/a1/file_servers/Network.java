 ...
 */
public class Network extends common.unversioned.a1.data.types.AbstractModel{
    ...
    protected String externalVirtualNetworkUuid;
    
    protected Boolean isInternalNetwork;
