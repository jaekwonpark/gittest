 ...
 */
public class NonNativeProtocolConfig extends common.unversioned.a1.data.types.AbstractModel{


    
    protected Boolean enableConcurrentReads;
    
    protected Boolean enableCasesensitiveNamespace;
    
    protected Boolean enableSymlinkCreation;
    
    protected Boolean enableSimulteneousAccess;
