 ...
 */
public class ClientException extends common.unversioned.a1.data.types.AbstractModel{


    
    protected String readOnlyAccessList;
    
    protected String readWriteAccessList;
    
    protected String noAccessList;
