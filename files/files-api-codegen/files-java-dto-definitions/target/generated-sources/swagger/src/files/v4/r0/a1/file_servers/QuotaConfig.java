 ...
 */
public class QuotaConfig extends common.unversioned.a1.data.types.ExternalizableAbstractModel{


    
    protected Integer sizeGib;
    
    protected files.v4.r0.a1.file_servers.UserOrGroupAccount userOrGroupAccount;
    
    protected files.v4.r0.a1.file_servers.EnforcementType enforcementType;
